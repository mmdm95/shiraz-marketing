...
final class AntiXSS
{
     ...
     * @var array
     */
    private $_naughty_attributes = array(
        'alert',
        'prompt',
        'confirm',
        'applet',
    ...
    /**
     * Add some strings to the "_naughty_attributes"-array.
     *
     * @param array $strings
     *
     * @return $this
     */
    public function addNaughtyAttributes(array $strings)
    {
        $this->_naughty_attributes = array_merge($strings, $this->_naughty_attributes);
    ...
    /**
     * Remove some strings from the "_naughty_attributes"-array.
     *
     * <p>
     * <br />
     * WARNING: Use this method only if you have a really good reason.
     ...
     * @return $this
     */
    public function removeNaughtyAttributes(array $strings)
    {
        $this->_naughty_attributes = array_diff(
            array_intersect($strings, $this->_naughty_attributes),
            $this->_naughty_attributes
        );
...
//        $naughty = 'alert|prompt|confirm|applet|audio|basefont|base|behavior|bgsound|blink|body|embed|expression|form|frameset|frame|head|html|ilayer|iframe|input|button|select|isindex|layer|link|meta|keygen|object|plaintext|style|script|textarea|title|math|video|source|svg|xml|xss|eval';
        $naughty = implode('|', $this->_naughty_attributes);
