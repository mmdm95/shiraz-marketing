                    ...
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span
                                    class="text-semibold">ویرایش نوشته ثابت</span>
                        </h5>
                    </div>
                </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input name="title" type="text" class="form-control"
                                                       placeholder="اجباری"
                                                       value="<?= $spValues['title'] ?? $spTrueValues['title'] ?? ''; ?>">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <span class="text-danger">*</span>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-4">
                                                        <input name="url_name" type="text" class="form-control"
                                                               placeholder="اجباری"
                                                               value="<?= $spValues['url_name'] ?? $spTrueValues['url_name'] ?? ''; ?>">
                                                    </div>
                                            ...
                                            <div class="row pt-20 no-padding-top">
                                                <div class="form-group col-md-12 mt-12">
                                                    ...
                                                    <textarea
                                                            ...
                                                            class="form-control"
                                                            name="body"
                                                            rows="10"><?= $spValues['body'] ?? $spTrueValues['body'] ?? ''; ?></textarea>
                                                </div>
                                            </div>
