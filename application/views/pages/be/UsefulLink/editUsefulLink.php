    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default"
                ...
                <div class="page-header-content border-bottom border-bottom-success">
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span class="text-semibold">ویرایش لینک مفید</span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">ویرایش لینک مفید</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url(); ?>admin/editUsefulLink/<?= $param[0]; ?>" method="post">
                            <?= $data['form_token']; ?>
                                ...
                                <div class="col-md-9">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h6 class="panel-title">مشخصات لینک</h6>
                                        ...
                                        <div class="panel-body">
                                                            ...
                                                            <div class="thumb">
                                                                <a class="display-inline-block"
                                                                   style="-webkit-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);-moz-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);">
                                                                    <img
                                                                        src="<?= set_value($uslVals['image'] ?? '', '', base_url() . $uslVals['image'], asset_url() . 'be/images/placeholder.jpg'); ?>"
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="media-heading">
                                                                ...
                                                                <a class="io-image-name display-block">
                                                                    <?= basename(set_value($uslVals['image'] ?? '')); ?>
                                                                </a>
                                                            </h6>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input name="title" type="text" class="form-control"
                                                       placeholder="اجباری" value="<?= $uslVals['title']; ?>">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <span class="text-danger">*</span>
                                                <label>لینک:</label>
                                                <input name="link" type="text" class="form-control ltr"
                                                       placeholder="<?= base_url(); ?>" value="<?= $uslVals['link']; ?>">
                                            </div>

                                            <div class="text-right col-md-12">
                                                <a href="<?= base_url('admin/manageUsefulLink'); ?>" class="btn btn-default mr-5">
                                                    بازگشت
                                                </a>
