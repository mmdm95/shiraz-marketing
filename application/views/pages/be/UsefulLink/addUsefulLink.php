    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default"
                ...
                <div class="page-header-content border-bottom border-bottom-success">
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span class="text-semibold">افزودن لینک مفید</span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?= base_url(); ?>admin/manageَUsefulLink">
                                لینک‌ها مفید
                            </a>
                        </li>
                        <li class="active">افزودن لینک مفید</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url(); ?>admin/addUsefulLink" method="post">
                            <?= $data['form_token']; ?>
