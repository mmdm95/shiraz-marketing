    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url('admin/shop/editProduct/' . $param[0]); ?>" method="post">
                            <?= $form_token; ?>
                                        ...
                                        <div class="panel-body">
                                            <div class="col-lg-12 mb-15">
                                                <div class="cursor-pointer pick-file border border-lg border-default"
                                                    ...
                                                    <input class="image-file" type="hidden"
                                                           name="image"
                                                           value="<?= $pValues['image'] ?? $pTrueValues['image'] ?? ''; ?>">
                                                            ...
                                                            <div class="thumb">
                                                                <a class="display-inline-block"
                                                                   style="-webkit-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);-moz-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);">
                                                                    <img src="<?= set_value($pValues['image'] ?? $pTrueValues['image'] ?? '', '', base_url($pValues['image'] ?? $pTrueValues['image'] ?? ''), asset_url('be/images/placeholder.jpg')); ?>"
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="media-heading">
                                                                ...
                                                                <a class="io-image-name display-block">
                                                                    <?= basename($pValues['image'] ?? $pTrueValues['image'] ?? ''); ?>
                                                                </a>
                                                            </h6>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group col-lg-6 col-md-8 col-sm-12">
                                                ...
                                                <input name="title" type="text" class="form-control"
                                                       placeholder="اجباری"
                                                       value="<?= $pValues['title'] ?? $pTrueValues['title'] ?? ''; ?>">
                                            </div>
                                                ...
                                                <select class="select-rtl" name="category">
                                                    ...
                                                    <?php foreach ($categories as $key => $category): ?>
                                                        <option value="<?= $category['id']; ?>"
                                                            <?= set_value($pValues['category'] ?? $pTrueValues['category_id'] ?? '', $category['id'], 'selected', '', '=='); ?>>
                                                            <?= $category['name']; ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="form-group pt-15 col-lg-2 col-md-2 col-sm-12">
                                                <div class="form-check form-check-right">
                                                    <label class="form-check-label ltr">
                                                        ...
                                                        <input type="radio" class="control-custom"
                                                            <?= set_value($pValues['product_type'] ?? $pTrueValues['product_type'] ?? '', PRODUCT_TYPE_SERVICE, 'checked', 'checked', '=='); ?>
                                                ...
                                                <div class="form-check form-check-right">
                                                    <label class="form-check-label ltr">
                                                        ...
                                                        <input type="radio" class="control-custom"
                                                            <?= set_value($pValues['product_type'] ?? $pTrueValues['product_type'] ?? '', PRODUCT_TYPE_ITEM, 'checked', '', '=='); ?>
                                                ...
                                                <select class="select-rtl" name="city">
                                                    ...
                                                    <?php foreach ($cities as $key => $city): ?>
                                                        <option value="<?= $city['id']; ?>"
                                                            <?= set_value($pValues['city'] ?? $pTrueValues['city_id'] ?? '', $city['id'], 'selected', '', '=='); ?>>
                                                            <?= $city['name']; ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <input name="place" type="text" class="form-control"
                                                       placeholder="محل"
                                                       value="<?= $pValues['place'] ?? $pTrueValues['place'] ?? ''; ?>">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-4 col-sm-12">
                                                <span class="text-danger">*</span>
                                                <label>قیمت:</label>
                                                <input name="price" type="text" class="form-control"
                                                       ...
                                                       value="<?= $pValues['price'] ?? $pTrueValues['price'] ?? ''; ?>">
                                            </div>
                                            ...
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <input name="keywords" type="text"
                                                       ...
                                                       data-role="tagsinput"
                                                       value="<?= $pValues['keywords'] ?? $pTrueValues['keywords'] ?? ''; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body no-padding">
                                            <textarea
                                                    ...
                                                    rows="10"><?= $pValues['description'] ?? $pTrueValues['description'] ?? ''; ?></textarea>
                                        </div>
                                    </div>
                                </div>
