                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group col-lg-12">
                                                <div class="cursor-pointer pick-file border border-lg border-default"
                                                    ...
                                                    <input class="image-file" type="hidden"
                                                           name="image"
                                                           value="<?= set_value($blogValues['image'] ?? ''); ?>">
                                                            ...
                                                            <div class="thumb">
                                                                <a class="display-inline-block"
                                                                   style="-webkit-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);-moz-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);">
                                                                    <img src="<?= set_value($blogValues['image'] ?? '', '', base_url($blogValues['image'] ?? ''), asset_url('be/images/placeholder.jpg')); ?>"
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="media-heading">
                                                                ...
                                                                <a class="io-image-name display-block">
                                                                    <?= basename(set_value($blogValues['image'] ?? '')); ?>
                                                                </a>
                                                            </h6>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group col-lg-8">
                                                ...
                                                <input name="title" type="text" class="form-control"
                                                       placeholder="اجباری"
                                                       value="<?= set_value($blogValues['title'] ?? ''); ?>">
                                            </div>
                                                ...
                                                <select class="select-rtl" name="category">
                                                    <?php foreach ($categories as $key => $category): ?>
                                                        <option value="<?= $category['id']; ?>"
                                                            <?= set_value($blogValues['category'] ?? '', $category['id'], 'selected', '', '=='); ?>>
                                                            <?= $category['name']; ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <textarea rows="5" cols="12" class="form-control"
                                                          ...
                                                          placeholder="خلاصه"><?= $blogValues['abstract'] ?? ''; ?></textarea>
                                            </div>
                                            <div class="form-group col-lg-12">
                                                <span class="text-danger">*</span>
                                                ...
                                                <input name="keywords" type="text"
                                                       ...
                                                       data-role="tagsinput"
                                                       value="<?= set_value($blogValues['keywords'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group col-lg-12 text-right">
                                                <label for="catStatus">وضعیت انتشار:</label>
                                                <input type="checkbox" name="publish" id="catStatus"
                                                       class="switchery" <?= set_value($blogValues['publish'] ?? '', 'off', '', 'checked', '=='); ?> />
                                            </div>
                                            <div class="row pt-20 no-padding-top">
                                                <div class="form-group col-md-12 mt-12">
                                                    ...
                                                    <textarea
                                                            ...
                                                            class="form-control"
                                                            name="body"
                                                            rows="10"><?= set_value($blogValues['body'] ?? ''); ?></textarea>
                                                </div>
                                            </div>
