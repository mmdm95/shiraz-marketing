...
<head>
    ...
    <link href="<?= asset_url(); ?>be/css/icons/icomoon/styles.css?<?= app_version(); ?>" rel="stylesheet"
          type="text/css">
    ...
    <script type="application/javascript"
            src="<?= asset_url(); ?>be/js/core/libraries/jquery.min.js?<?= app_version(); ?>"></script>
    <script type="application/javascript"
            src="<?= asset_url(); ?>be/js/plugins/ui/ripple.min.js?<?= app_version(); ?>"></script>
